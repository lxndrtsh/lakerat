                ...
                <div class="col-lg-12 text-center">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-lg-offset-3 text-center">
                                    <p>Sirloin with grilled on BBQ sauce, cheddar cheese, then topped with our onion-jalape&tilde;o straws.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-lg-offset-3 text-center">
                                    <p>Our spice rubbed, braised, and pulled pork piled high! Topped with your favorite slaw and onion-jalape&tilde;o straws.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <h3>Shrimp and Boudin Po'Boy - $12</h3>
                            <div class="row">
                                <div class="col-lg-6 col-lg-offset-3 text-center">
