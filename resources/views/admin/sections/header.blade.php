...
<div class="navbar" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html#"><img src="/admin/assets/img/logo.png"> cleverAdmin</a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
                <a href="index.html#" class="dropdown-toggle avatar" data-toggle="dropdown"><img src="/admin/assets/img/avatar.jpg"><span class="badge">9</span></a>
                <ul class="dropdown-menu">
